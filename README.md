...
## Example Uses
* Access your QR code to check in and grab food
* View a timer counting down to the deadline
* View announcements
* Browse events going on at the hackathon
* View a map to find sponsor tables, bathrooms, the eating area, etc.
