...
public class MapActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (!SharedPreferencesUtility.getMapUsed(MapActivity.this)) {
            AlertDialog.Builder builder = new AlertDialog.Builder(MapActivity.this, R.style.AppTheme_Dialogue_Alert);
            builder.setMessage("Pinch to zoom to get a better look!")
...
//        Log.e(TAG, mapRef.getBucket());
        ImageView mapImage = (ImageView) mContentView;
